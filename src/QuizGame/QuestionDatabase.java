...
public class QuestionDatabase {
    ...
    public List<Questions> addQuestionsForCategory(eCategoryType categoryType) {
        ...
        if (filmQuestions.isEmpty()) {
            filmQuestions.add(new Questions("What is the name of the foley artist who designed the famous sounds of Star Wars, including Chewbacca's roar and R2D2's beeps and whistles?", new String[]{"Hank Bowley", "Tom Sagan", "Ben Burtt", "Luke Edward"}, "Ben Burtt", eCategoryType.MOVIES));
            filmQuestions.add(new Questions("Which actor played the main character in the 1990 film &quot;Edward Scissorhands&quot;?", new String[]{"Clint Eastwood", "Leonardo Dicaprio", "Ben Stiller", "Johnny Depp"}, "Johnny Depp", eCategoryType.MOVIES));
            filmQuestions.add(new Questions("Which of the following films was NOT directed by Quentin Tarantino?", new String[]{"From Dusk till Dawn", "Jackie Brown", "Pulp Fiction", "Reservoir Dogs"}, "From Dusk till Dawn", eCategoryType.MOVIES));
            filmQuestions.add(new Questions("What was another suggested name for, the 1985 film, Back to the Future?", new String[]{"Hill Valley Time Travelers", "The Time Travelers", "Spaceman From Pluto", "The Lucky Man"}, "Spaceman From Pluto", eCategoryType.MOVIES));
        }
